...
with st.expander("🩺 Daftar Penyakit Daun Tomat yang Dapat Deteksi"):
    ...
    0. **Tomato Bacterial Spot** – Bercak gelap kecil menyebar pada daun.
    1. **Tomato Early Blight** – Bercak coklat besar dengan pola cincin.
    2. **Tomato Late Blight** – Daun basah kehijauan berubah menjadi hitam.
    3. **Tomato Leaf Mold** – Lapisan kuning/hijau pucat di atas daun.
    4. **Tomato Septoria Leaf Spot** – Bercak abu-abu kecil dengan tepi gelap.
    5. **Tomato Spider Mites (Two-Spotted)** – Bercak putih kecil + jaring halus.
    6. **Tomato Target Spot** – Bercak coklat bundar dengan pusat terang.
    7. **Tomato Yellow Leaf Curl Virus** – Daun keriting dan kuning pucat.
